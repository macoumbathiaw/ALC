...
public class ContactUsJavaLinesOfCodes extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        email.setOnClickListener(new View.OnClickListener() {
            ...
            /* Fill it with Data */
                ...
                sendEmail.putExtra(android.content.Intent.EXTRA_EMAIL, new String[]{"macoumbathiaw00@gmail.com"});
